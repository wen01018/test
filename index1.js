...
function send() {
  ...
  let exvo = $('input:radio:checked[name="exvoValue"]').val(); 
  let exvq1q = $('input:radio:checked[name="exvq1qValue"]').val(); 
  let exvq1type = $('input:radio:checked[name="exvq1typeValue"]').val(); 
  let exvq1poss = $('input:radio:checked[name="exvq1possValue"]').val(); 
  let exvq1sev = $('input:radio:checked[name="exvq1sevValue"]').val(); 
  let exvq1risk = $('input:radio:checked[name="exvq1riskValue"]').val(); 
  ...
  */
  let exvq2q = $('input:radio:checked[name="exvq2qValue"]').val(); 
  let exvq2type = $('input:radio:checked[name="exvq2typeValue"]').val(); 
  let exvq2poss = $('input:radio:checked[name="exvq2possValue"]').val(); 
  let exvq2sev = $('input:radio:checked[name="exvq2sevValue"]').val(); 
  let exvq2risk = $('input:radio:checked[name="exvq2riskValue"]').val(); 
  ...
  */
  let exvq3q = $('input:radio:checked[name="exvq3qValue"]').val(); 
  let exvq3type = $('input:radio:checked[name="exvq3typeValue"]').val(); 
  let exvq3poss = $('input:radio:checked[name="exvq3possValue"]').val(); 
  let exvq3sev = $('input:radio:checked[name="exvq3sevValue"]').val(); 
  let exvq3risk = $('input:radio:checked[name="exvq3riskValue"]').val(); 
  ...
  */
  let exvq4q = $('input:radio:checked[name="exvq4qValue"]').val(); 
  let exvq4type = $('input:radio:checked[name="exvq4typeValue"]').val(); 
  let exvq4poss = $('input:radio:checked[name="exvq4possValue"]').val(); 
  let exvq4sev = $('input:radio:checked[name="exvq4sevValue"]').val(); 
  let exvq4risk = $('input:radio:checked[name="exvq4riskValue"]').val(); 
  ...
  */
  let exvq5q = $('input:radio:checked[name="exvq5qValue"]').val(); 
  let exvq5type = $('input:radio:checked[name="exvq5typeValue"]').val(); 
  let exvq5poss = $('input:radio:checked[name="exvq5possValue"]').val(); 
  let exvq5sev = $('input:radio:checked[name="exvq5sevValue"]').val(); 
  let exvq5risk = $('input:radio:checked[name="exvq5riskValue"]').val(); 
  ...
  */
 let exvq6q = $('input:radio:checked[name="exvq6qValue"]').val(); 
 let exvq6type = $('input:radio:checked[name="exvq6typeValue"]').val(); 
 let exvq6poss = $('input:radio:checked[name="exvq6possValue"]').val(); 
 let exvq6sev = $('input:radio:checked[name="exvq6sevValue"]').val(); 
 let exvq6risk = $('input:radio:checked[name="exvq6riskValue"]').val(); 
  ...
  */
 let exvq7q = $('input:radio:checked[name="exvq7qValue"]').val(); 
 let exvq7type = $('input:radio:checked[name="exvq7typeValue"]').val(); 
 let exvq7poss = $('input:radio:checked[name="exvq7possValue"]').val(); 
 let exvq7sev = $('input:radio:checked[name="exvq7sevValue"]').val(); 
 let exvq7risk = $('input:radio:checked[name="exvq7riskValue"]').val(); 
  ...
  */
 let exvq8q = $('input:radio:checked[name="exvq8qValue"]').val(); 
 let exvq8type = $('input:radio:checked[name="exvq8typeValue"]').val(); 
 let exvq8poss = $('input:radio:checked[name="exvq8possValue"]').val(); 
 let exvq8sev = $('input:radio:checked[name="exvq8sevValue"]').val(); 
 let exvq8risk = $('input:radio:checked[name="exvq8riskValue"]').val(); 
  ...
  */
 let exvq9q = $('input:radio:checked[name="exvq9qValue"]').val(); 
 let exvq9type = $('input:radio:checked[name="exvq9typeValue"]').val(); 
 let exvq9poss = $('input:radio:checked[name="exvq9possValue"]').val(); 
 let exvq9sev = $('input:radio:checked[name="exvq9sevValue"]').val(); 
 let exvq9risk = $('input:radio:checked[name="exvq9riskValue"]').val(); 
  ...
  */
 let exvq10q = $('input:radio:checked[name="exvq10qValue"]').val(); 
 let exvq10type = $('input:radio:checked[name="exvq10typeValue"]').val(); 
 let exvq10poss = $('input:radio:checked[name="exvq10possValue"]').val(); 
 let exvq10sev = $('input:radio:checked[name="exvq10sevValue"]').val(); 
 let exvq10risk = $('input:radio:checked[name="exvq10riskValue"]').val(); 
  ...
  */
 let exvq11q = $('input:radio:checked[name="exvq11qValue"]').val(); 
 let exvq11type = $('input:radio:checked[name="exvq11typeValue"]').val(); 
 let exvq11poss = $('input:radio:checked[name="exvq11possValue"]').val(); 
 let exvq11sev = $('input:radio:checked[name="exvq11sevValue"]').val(); 
 let exvq11risk = $('input:radio:checked[name="exvq11riskValue"]').val(); 
  ...
  */
 let exvq12q = $('input:radio:checked[name="exvq12qValue"]').val(); 
 let exvq12type = $('input:radio:checked[name="exvq12typeValue"]').val(); 
 let exvq12poss = $('input:radio:checked[name="exvq12possValue"]').val(); 
 let exvq12sev = $('input:radio:checked[name="exvq12sevValue"]').val(); 
 let exvq12risk = $('input:radio:checked[name="exvq12riskValue"]').val(); 
  ...
  */
 let exvq13q = $('input:radio:checked[name="exvq13qValue"]').val(); 
 let exvq13type = $('input:radio:checked[name="exvq13typeValue"]').val(); 
 let exvq13poss = $('input:radio:checked[name="exvq13possValue"]').val(); 
 let exvq13sev = $('input:radio:checked[name="exvq13sevValue"]').val(); 
 let exvq13risk = $('input:radio:checked[name="exvq13riskValue"]').val(); 
  ...
  */
 let exvq14q = $('input:radio:checked[name="exvq14qValue"]').val(); 
 let exvq14type = $('input:radio:checked[name="exvq14typeValue"]').val(); 
 let exvq14poss = $('input:radio:checked[name="exvq14possValue"]').val(); 
 let exvq14sev = $('input:radio:checked[name="exvq14sevValue"]').val(); 
 let exvq14risk = $('input:radio:checked[name="exvq14riskValue"]').val(); 
  ...
  */
 let exvq15q = $('input:radio:checked[name="exvq15qValue"]').val(); 
 let exvq15type = $('input:radio:checked[name="exvq15typeValue"]').val(); 
 let exvq15poss = $('input:radio:checked[name="exvq15possValue"]').val(); 
 let exvq15sev = $('input:radio:checked[name="exvq15sevValue"]').val(); 
 let exvq15risk = $('input:radio:checked[name="exvq15riskValue"]').val(); 
 ...
 let wovq1sev = $('input:radio:checked[name="wovq1sevValue"]').val(); 
 let wovq1risk = $('input:radio:checked[name="wovq1riskValue"]').val(); 
  ...
  */
 let wovq2q = $('input:radio:checked[name="wovq2qValue"]').val(); 
 let wovq2type = $('input:radio:checked[name="wovq2typeValue"]').val(); 
 let wovq2poss = $('input:radio:checked[name="wovq2possValue"]').val(); 
 let wovq2sev = $('input:radio:checked[name="wovq2sevValue"]').val(); 
 let wovq2risk = $('input:radio:checked[name="wovq2riskValue"]').val(); 
  ...
  */
 let wovq3q = $('input:radio:checked[name="wovq3qValue"]').val(); 
 let wovq3type = $('input:radio:checked[name="wovq3typeValue"]').val(); 
 let wovq3poss = $('input:radio:checked[name="wovq3possValue"]').val(); 
 let wovq3sev = $('input:radio:checked[name="wovq3sevValue"]').val(); 
 let wovq3risk = $('input:radio:checked[name="wovq3riskValue"]').val(); 
  ...
  */
 let wovq4q = $('input:radio:checked[name="wovq4qValue"]').val(); 
 let wovq4type = $('input:radio:checked[name="wovq4typeValue"]').val(); 
 let wovq4poss = $('input:radio:checked[name="wovq4possValue"]').val(); 
 let wovq4sev = $('input:radio:checked[name="wovq4sevValue"]').val(); 
 let wovq4risk = $('input:radio:checked[name="wovq4riskValue"]').val(); 
  ...
  */
 let wovq5q = $('input:radio:checked[name="wovq5qValue"]').val(); 
 let wovq5type = $('input:radio:checked[name="wovq5typeValue"]').val(); 
 let wovq5poss = $('input:radio:checked[name="wovq5possValue"]').val(); 
 let wovq5sev = $('input:radio:checked[name="wovq5sevValue"]').val(); 
 let wovq5risk = $('input:radio:checked[name="wovq5riskValue"]').val(); 
  ...
  */
 let wovq6q = $('input:radio:checked[name="wovq6qValue"]').val(); 
 let wovq6type = $('input:radio:checked[name="wovq6typeValue"]').val(); 
 let wovq6poss = $('input:radio:checked[name="wovq6possValue"]').val(); 
 let wovq6sev = $('input:radio:checked[name="wovq6sevValue"]').val(); 
 let wovq6risk = $('input:radio:checked[name="wovq6riskValue"]').val(); 
  ...
  */
 let wovq7q = $('input:radio:checked[name="wovq7qValue"]').val(); 
 let wovq7type = $('input:radio:checked[name="wovq7typeValue"]').val(); 
 let wovq7poss = $('input:radio:checked[name="wovq7possValue"]').val(); 
 let wovq7sev = $('input:radio:checked[name="wovq7sevValue"]').val(); 
 let wovq7risk = $('input:radio:checked[name="wovq7riskValue"]').val(); 
  ...
  */
 let wovq8q = $('input:radio:checked[name="wovq8qValue"]').val(); 
 let wovq8type = $('input:radio:checked[name="wovq8typeValue"]').val(); 
 let wovq8poss = $('input:radio:checked[name="wovq8possValue"]').val(); 
 let wovq8sev = $('input:radio:checked[name="wovq8sevValue"]').val(); 
 let wovq8risk = $('input:radio:checked[name="wovq8riskValue"]').val(); 
  ...
  */
 let wovq9q = $('input:radio:checked[name="wovq9qValue"]').val(); 
 let wovq9type = $('input:radio:checked[name="wovq9typeValue"]').val(); 
 let wovq9poss = $('input:radio:checked[name="wovq9possValue"]').val(); 
 let wovq9sev = $('input:radio:checked[name="wovq9sevValue"]').val(); 
 let wovq9risk = $('input:radio:checked[name="wovq9riskValue"]').val(); 
  ...
  */
 let wovq10q = $('input:radio:checked[name="wovq10qValue"]').val(); 
 let wovq10type = $('input:radio:checked[name="wovq10typeValue"]').val(); 
 let wovq10poss = $('input:radio:checked[name="wovq10possValue"]').val(); 
 let wovq10sev = $('input:radio:checked[name="wovq10sevValue"]').val(); 
 let wovq10risk = $('input:radio:checked[name="wovq10riskValue"]').val(); 
